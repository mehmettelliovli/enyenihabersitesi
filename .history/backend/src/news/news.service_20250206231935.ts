...
export class NewsService {
  ...
  async findByCategoryLatest(categoryId: number, limit: number = 5): Promise<News[]> {
    return this.newsRepository.find({
      where: { 
        category: { id: categoryId },
        isActive: true 
  ...
  async findByCategoryOlder(categoryId: number): Promise<News[]> {
    return this.newsRepository.find({
      where: { 
        category: { id: categoryId },
        isActive: true 
